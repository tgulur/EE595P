...
#ifndef NS3_BERNOULLI_PACKET_SOCKET_CLIENT_H
#define NS3_BERNOULLI_PACKET_SOCKET_CLIENT_H
 ...
 *
 * Packets are sent as soon as BernoulliPacketSocketClient::Start is called.
 ...
 */
class BernoulliPacketSocketClient : public Application
{
  public:
    /**
    ...
    BernoulliPacketSocketClient();

    ~BernoulliPacketSocketClient() override;
  ...
  private:
    ...
    Ptr<UniformRandomVariable> m_uniformRngForInterval;
    Ptr<UniformRandomVariable> m_uniformRngForTid;
    Time m_timeSlot;
    double m_bernoulliPr;
...
#endif // NS3_BERNOULLI_PACKET_SOCKET_CLIENT_H
