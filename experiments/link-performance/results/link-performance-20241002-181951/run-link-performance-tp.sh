...
# and produces a plot of PER vs. transmit power.
...
plotName='link-performance-per-vs-transmit-power.pdf'
plotTitle='PER vs. Transmit Power'
...
# Set the range of transmit power (in dBm)
minTransmitPower=-10  # Starting at a low transmit power
maxTransmitPower=20   # Stepping to a high enough power to reduce PER to 0
stepSize=2            # Step size for transmit power
