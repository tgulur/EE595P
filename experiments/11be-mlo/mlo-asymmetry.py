...
def main():
    ...
    # draw plots
    plt.figure(1)
    plt.title('Throughput vs. Offered Load (Channel 1 = 20MHz, Channel 2 = 80 MHz)')
    ...
    plt.savefig(os.path.join(results_dir, 'wifi-mld-cw20-cw80.png'))

    plt.figure(2)
    plt.title('E2E Delay vs. Offered Load (Channel 1 = 20MHz, Channel 2 = 80 MHz)')
    plt.xlabel('Offered Load')
    ...
    plt.savefig(os.path.join(results_dir,'wifi-e2e-cs20-cs80.png'))

    plt.figure(3)
    plt.title('Queue Delay vs. Offered Load (Channel 1 = 20MHz, Channel 2 = 80 MHz)')
    plt.xlabel('Offered Load')
    ...
    plt.savefig(os.path.join(results_dir,'wifi-queue-cw20-cw80.png'))

    plt.figure(4)
    plt.title('Access Delay vs. Offered Load (Channel 1 = 20MHz, Channel 2 = 80 MHz)')
    plt.xlabel('Offered Load')
    ...
    plt.savefig(os.path.join(results_dir,'wifi-acc-cw20-cw80.png'))
